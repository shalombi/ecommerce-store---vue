...
<template>
    <section class="product-edit mt-36">
        <h1>Product edit</h1>
        ...
        <!-- <div>
                ...
                <div class="mt-2">
                    <input name="vendor" id="vendor" input type="text" v-model="productToEdit.vendor"
    ...
    <form class="" @submit.prevent="addProduct()" v-if="productToEdit">
        <div class="space-y-12 sm:space-y-16">
            <div>
                <h2 class="text-base font-semibold leading-7 text-gray-900">Profile</h2>
                <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-600">This information will be displayed publicly so be
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        ...
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            <div
                                ...
                                <input name="vendor" id="vendor" type="text" v-model="productToEdit.vendor"
            ...
            <div>
                ...
                <div
                    class="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">First
                            name</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="region" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">State /
                            Province</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="postal-code" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">מחיר</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            <input name="price" id="vendor" type="number" v-model="productToEdit.price"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6" />
                        </div>
            ...
            <div>
                ...
                <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-600">We'll always let you know about important changes,
                                ...
                                <div class="max-w-lg space-y-6">
                                    <div class="relative flex gap-x-3">
                                        ...
                                        <div class="text-sm leading-6">
                                            ...
                                            <p class="mt-1 text-gray-600">Get notified when someones posts a comment on a
                                                posting.</p>
                                        </div>
                                    </div>
                                    <div class="relative flex gap-x-3">
                                        ...
                                        <div class="text-sm leading-6">
                                            ...
                                            <p class="mt-1 text-gray-600">Get notified when a candidate applies for a job.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="relative flex gap-x-3">
                                        ...
                                        <div class="text-sm leading-6">
                                            ...
                                            <p class="mt-1 text-gray-600">Get notified when a candidate accepts or rejects
                                                an offer.</p>
                                        </div>
                                    </div>
                                </div>
